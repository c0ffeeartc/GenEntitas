...
";
		...
		{
			return context.CreateCollector( MainMatcher.AllOf( MainMatcher.Comp, MainMatcher.UniqueComp ).NoneOf( MainMatcher.PublicFieldsComp, MainMatcher.DontGenerateComp ) );
		}
